...
public class CombatGui extends JFrame {
    ...
    public void targetSelectorMode(CharacterNode[] fighters){
        ...
        inputPanel.add(createButton(current.getName(), activeColor, i), coords);
        }
    ...
    public void moveSelectorMode(CharacterNode[] fighters){
    ...
    private JButton createButton(String text, Color color, int number) {
